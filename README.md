...
Projeto desenvolvido durante o Curso de Desenvolvimento WEB, Turma 12, da [trybe](https://www.betrybe.com/), onde desenvolvi minhas habilidades em JavaScript, Node.js, Express.js e MongoDB, na criação de uma API REST, aplicando a arquitetura MSC, agora efetuando autenticação de usuário por meio do JWT e upload de arquivo através do multer.
